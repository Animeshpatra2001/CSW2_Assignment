/*Q6. Library System Assignment: Task: Develop a Java program for a library system incorporating encapsulation, abstraction, and inheritance.
...
public class Q6_LibrarySystem {
	public static void main(String[] args) {

		Book book = new Book("Java Programming", "Mayur Ramgir", 500);
		Magazine magazine = new Magazine("National Geographic", "Various Authors", "March 2024");
		DVD dvd = new DVD("The Matrix", "The Wachowskis", 136);
